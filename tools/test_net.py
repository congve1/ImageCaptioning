...
def test_net(cfg, verbose=False, distributed=False):
    ...
    val_data_loader = make_data_loader(cfg, split='test', is_distributed=distributed)
...
def main():
    ...
    logger = setup_logger('image_captioning', cfg.OUTPUT_DIR, get_rank(), "test_log.txt")
    ...
    test_net(cfg, args.verbose, args.distributed)
